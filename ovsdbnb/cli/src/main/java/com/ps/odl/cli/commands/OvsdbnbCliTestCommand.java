...
public class OvsdbnbCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(OvsdbnbCliTestCommand.class);
    protected final OvsdbnbCliCommands service;

    public OvsdbnbCliTestCommand(final OvsdbnbCliCommands service) {
